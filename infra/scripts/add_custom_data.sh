...
echo "Search Service Name: $aiSearchName"
echo "Search Endpoint: $searchEndpoint"
echo "OpenAI Endpoint: $openaiEndpoint"
echo "OpenAI Embedding Model: $embeddingModel"
echo "OpenAI Deployment Model: $deploymentModel"
...
if [ $? -ne 0 ]; then
	echo "Error: add_custom_data.py failed."
	exit 1
fi
